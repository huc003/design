    ...
    public static void getResult(Integer[] arr) {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            for (int j = 0; j < 20 && i + j <= 35; j++) {
                ...
                //从右开始循环
                if (i >= 3 && j <= 16) {
                    th = arr[20 * j + i] * arr[20 * j + i + 19] * arr[20 * j + i + 19 * 2] * arr[20 * j + i + 19 * 3];
                    if (max < th) {
                        max = th;
                    }
                }
                //从左开始循环
                if (i <= 16 && j <= 16) {
                    th = arr[20 * j + i] * arr[20 * j + i + 21] * arr[20 * j + i + 21 * 2] * arr[20 * j + i + 21 * 3];
                    if (max < th) {
                        max = th;
                    }
                }
